...
export default function Signup() {
    ...
    const onSubmit = async (data: { username: string, password: string }) => {
        setFormLoading(true);
        try {
            const res = await axios.post(import.meta.env.VITE_BE_DOMAIN + 'signup', {
    ...
    return (
        <div style={{ backgroundImage: 'url("bg.jpeg")' }}
            ...
            <form className='lg:w-[30vw] md:w-[70vw] w-[90vw] bg-opacity-75 flex flex-col justify-center bg-[rgba(30,41,50,0.9)] text-white p-5 rounded-md min-h-[50vh]'
                ...
                <p className='text-center pt-4'>Have an account ? <NavLink className='text-blue-700 hover:underline underline-offset-2'
